...
public class GetComInfoUtil {
    public void property() throws UnknownHostException{
        ...
        System.out.println("java运行环境供应商："+ props.getProperty("java.vendor"));
        ...
        System.out.println("java虚拟机规范供应商："+ props.getProperty("java.vm.specification.vendor"));
        System.out.println("java虚拟规范名称："+ props.getProperty("java.vm.specification.name"));
        System.out.println("java虚拟机实现版本："+ props.getProperty("java.vm,version"));
        System.out.println("java虚拟机实现供应商："+ props.getProperty("java.vm.vendor"));
        System.out.println("java虚拟机实现名称："+ props.getProperty("java.vm.name"));
